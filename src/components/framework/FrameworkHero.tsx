...
export function FrameworkHero() {
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-[90vh] flex flex-col justify-center bg-white text-[#18181B] pb-24 pt-48 px-6 md:px-16 overflow-hidden">
